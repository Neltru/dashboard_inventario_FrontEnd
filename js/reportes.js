...
function construirUI() {
  const main = document.querySelector(".max-w-7xl");
  ...
  seccion.innerHTML = `
    ...
    <div class="flex justify-between items-center mb-4">
      <div>
        ...
        <p class="text-sm text-gray-500">Historial de cambios de stock</p>
      </div>
      <button id="btnActualizarReportes"
        class="flex items-center gap-2 border border-gray-300 px-4 py-2 rounded-lg
    ...
    <div class="bg-white rounded-xl shadow px-4 py-3 flex flex-wrap gap-2 items-center mb-4">
      ...
      <!-- Contador -->
      <span id="contadorMovimientos" class="ml-auto text-xs text-gray-400"></span>
    </div>
    ...
    <div class="bg-white rounded-xl shadow overflow-hidden">
      ...
      <!-- Sin datos -->
      <div id="reportesVacio" class="hidden flex-col items-center justify-center py-16 text-gray-400 gap-3">
        ...
        <p class="text-sm font-medium">No hay movimientos cargados</p>
        <button id="btnVerMovimientos" class="mt-2 px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition">
          Ver Movimientos
        </button>
      </div>
